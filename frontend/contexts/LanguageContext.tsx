...
const translations: Record<Language, Record<string, string>> = {
  tr: {
    ...
    'blog.title': 'Blog',
    'blog.subtitle': 'Öngel Gayrimenkul\'den haberler, ipuçları ve güncel gelişmeler',
    'blog.search': 'Blog yazılarında ara...',
    'blog.searchButton': 'Ara',
    'blog.clear': 'Temizle',
    'blog.sortBy': 'Sırala:',
    'blog.sortByPublished': 'Yayın Tarihi',
    'blog.sortByCreated': 'Oluşturulma Tarihi',
    'blog.sortByUpdated': 'Güncelleme Tarihi',
    'blog.sortByTitle': 'Başlık',
    'blog.sortDesc': 'Azalan',
    'blog.sortAsc': 'Artan',
    'blog.resultsFound': 'sonuç bulundu',
    'blog.loading': 'Yükleniyor...',
    'blog.noPosts': 'Henüz blog yazısı bulunmamaktadır.',
    'blog.noPostsSoon': 'Yakında yeni içerikler eklenecektir.',
    'blog.readMore': 'Devamını oku →',
    'blog.backToBlog': '← Blog sayfasına dön',
    'blog.backToAll': '← Tüm blog yazılarına dön',
  ...
  en: {
    ...
    'blog.title': 'Blog',
    'blog.subtitle': 'News, tips and latest updates from Öngel Gayrimenkul',
    'blog.search': 'Search blog posts...',
    'blog.searchButton': 'Search',
    'blog.clear': 'Clear',
    'blog.sortBy': 'Sort by:',
    'blog.sortByPublished': 'Publication Date',
    'blog.sortByCreated': 'Creation Date',
    'blog.sortByUpdated': 'Update Date',
    'blog.sortByTitle': 'Title',
    'blog.sortDesc': 'Descending',
    'blog.sortAsc': 'Ascending',
    'blog.resultsFound': 'results found',
    'blog.loading': 'Loading...',
    'blog.noPosts': 'No blog posts available yet.',
    'blog.noPostsSoon': 'New content will be added soon.',
    'blog.readMore': 'Read more →',
    'blog.backToBlog': '← Back to blog',
    'blog.backToAll': '← Back to all blog posts',
  ...
  ar: {
    ...
    'blog.title': 'المدونة',
    'blog.subtitle': 'أخبار ونصائح وآخر التحديثات من أونجل العقارية',
    'blog.search': 'البحث في المدونة...',
    'blog.searchButton': 'بحث',
    'blog.clear': 'مسح',
    'blog.sortBy': 'ترتيب حسب:',
    'blog.sortByPublished': 'تاريخ النشر',
    'blog.sortByCreated': 'تاريخ الإنشاء',
    'blog.sortByUpdated': 'تاريخ التحديث',
    'blog.sortByTitle': 'العنوان',
    'blog.sortDesc': 'تنازلي',
    'blog.sortAsc': 'تصاعدي',
    'blog.resultsFound': 'نتيجة موجودة',
    'blog.loading': 'جاري التحميل...',
    'blog.noPosts': 'لا توجد مقالات متاحة بعد.',
    'blog.noPostsSoon': 'سيتم إضافة محتوى جديد قريباً.',
    'blog.readMore': 'اقرأ المزيد →',
    'blog.backToBlog': '← العودة إلى المدونة',
    'blog.backToAll': '← العودة إلى جميع المقالات',
    ...
    'blog.next': 'التالي',
    'blog.last': 'الأخير',
    'blog.error': 'حدث خطأ أثناء تحميل المقالات.',
  },
};
